...
workspace = 'scm-Deployment_Solution'
Build = build.version
...
def Copy_LPMSI():
  ...
  Builddev_LP_DIR = r'\\builddev\buildtest\DeploymentSolution\Daily_Builds\trunk\LanguagePacks\%s' % Build
  ...
  if os.path.isfile(Builddev_LP_DIR + '\\Altiris_DeploymentSolutionLanguages_x86_7_1.msi'):
    os.rename(Builddev_LP_DIR + '\\Altiris_DeploymentSolutionLanguages_x86_7_1.msi', Builddev_LP_DIR + '\\Altiris_DeploymentSolutionLanguages_7_1_x86.msi')
  if os.path.isfile(Builddev_LP_DIR + '\\Altiris_DeploymentSolutionLanguages_x64_7_1.msi'):
    os.rename(Builddev_LP_DIR + '\\Altiris_DeploymentSolutionLanguages_x64_7_1.msi', Builddev_LP_DIR + '\\Altiris_DeploymentSolutionLanguages_7_1_x64.msi')
  #copy to output_msi for ITMS BUILD
  if os.path.exists(c'C:\\output_msi')
    os.rmdir('C:\output_msi')
  if not os.path.exists('C:\\output_msi')
    os.makedirs('C:\\output_msi')
  #copy renamed MSI To output_msi
  shutil.copy(Builddev_LP_DIR + '\\Altiris_DeploymentSolutionLanguages_7_1_x64.msi', 'C:\\output_msi')
